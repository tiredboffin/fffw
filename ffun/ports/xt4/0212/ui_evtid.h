...
TRACKPAD_8DIRKEY=0x180,
STUDIO_ECO_STOP_TRG=0x190,
UI_INTERNAL_TP=0x1a0,
UI_STILL_RELEASE_PRIORITY=0x1b0,
SYS_INIT=0x1000000,
...
SYS_FLASH_MODEL=0x10e0000,
SETUP_INIT=0x10f0000,
SETUP_DISPLAY=0x1100000,
SETUP_DEINIT=0x1110000,
FMODE_START=0x1120000,
UPDATE_INIT=0x1130000,
UPDATE_DEINIT=0x1140000,
UPDATE_START=0x1150000,
UPDATE_WRITE=0x1160000,
SYS_DSC_SLEEP=0x1170000,
SYS_EXT_MICROPHONE=0x1180000,
SYS_SOUND_LEVEL=0x1190000,
SYS_LENS_POWER=0x11a0000,
SYS_LENS_DATA=0x11b0000,
SYS_LENS_KEY=0x11c0000,
SYS_BATTERY_SELECT=0x11d0000,
SYS_BACKGROUND_TRANSFER_CONNECTION=0x11e0000,
SYS_BT_SYNC_DATETIME=0x11f0000,
SYS_BT_SYNC_LOCATION=0x1200000,
SYS_BIS_CONTROL=0x1210000,
SYS_FOLDER_LIST=0x1220000,
SYS_BT_INITIAL_PAIRING=0x1230000,
SYS_BT_CONNECTION=0x1240000,
REC_INIT=0x2000000,
...
REC_MF=0x2050000,
REC_RTMF=0x2060000,
REC_SNAPMF=0x2070000,
REC_MOVIE=0x2080000,
REC_ONEPUSH_AF=0x2090000,
REC_S1=0x20a0000,
REC_S1OFF=0x20b0000,
REC_SETPARAM=0x20c0000,
REC_SINGLE=0x20d0000,
REC_VIEW=0x20e0000,
REC_ZOOM=0x20f0000,
REC_LIVE=0x2100000,
REC_MOVE_CHASE=0x2110000,
REC_IMAGE_BUFFER_CLEAR=0x2120000,
REC_PREVIEW=0x2130000,
REC_PIXEL_MAPPING=0x2140000,
REC_FINDER_ZOOM=0x2150000,
REC_AEAFAWBLOCK=0x2160000,
REC_AFON=0x2170000,
REC_TTL_LOCK_ADJUST=0x2180000,
REC_PCSH_CAPFOCUSPOS=0x2190000,
REC_PCSH_SETFOCUSPOS=0x21a0000,
REC_MOVIE_AF=0x21b0000,
REC_DEVELOP_PARAMETER=0x21c0000,
REC_DEVELOP_RAW=0x21d0000,
REC_FOCUS_POS_SET=0x21e0000,
REC_FOCUS_POS_PRESET=0x21f0000,
REC_PRE_RECSTART=0x2200000,
REC_FACE_SELECT_CMD=0x2210000,
REC_FOCUS_BKT_POS_SET=0x2220000,
REC_ZOOM_DRIVE=0x2230000,
REC_LEVERMF=0x2240000,
PB_INIT=0x4000000,
PB_DEINIT=0x4010000,
PB_SELECT=0x4020000,
...
SHOOTING_WIFI=0x80f0000,
SHOOTING_DUMMY=0x8100000,
IRDA_INIT=0x9000000,
